from flask import Flask, session, redirect, render_template, flash, url_for, send_file
...
@app.route('/horse_admin', methods=['GET'])
def horse_admin():
    """
...
def horse():
    return send_file("static/img/horse.jpg")
...
@app.route('/horse/<int:car_id>', methods=['GET'])
def car(car_id):
    """
...
@app.route('/delete_horse/<int:car_id>', methods=['GET'])
...
@app.route('/buy_horse/<int:car_id>', methods=['GET'])
...
@app.route('/search_breed', methods=['GET', 'POST'])
def search_breed():
    """
...
@app.route('/breed_admin', methods=['GET'])
def breed_admin():
    """
...
@app.route('/breed/<int:dealer_id>', methods=['GET'])
def breed(dealer_id):
    """
...
@app.route('/delete_breed/<int:car_id>', methods=['GET'])
